...
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'http://localhost:1234', 'https://renee-myflix-api-2507fb668e0f.herokuapp.com', 'https://reneemovieflixapp.netlify.app'];
app.use(cors({
